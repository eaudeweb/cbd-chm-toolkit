...
<?php if (variable_get('environment') == 'devel'):?><div style="font-size: 25px; font-weight: bold; text-align: center; background: red; color: white; height: 30px; padding-top: 10px;">DEVEL ENVIRONMENT</div><?php endif; ?>
<?php if ($main_menu): ?>
...
<div id="header" class="clearfix header" role="banner">
  <div class="container">
    <div class="row">
      <div class="header-section <?php if (($page['search_box']) || ($page['site_login'])): print 'span9'; else: print 'span12'; endif; ?>">
        <?php if ($logo): ?>
...
<div id="footer" class="clearfix site-footer" role="contentinfo">
  <div class="container">
    <div id="footer-content" class="row-fluid footer-content content-row"> 
	<?php if ($page['footer_col_1']): ?>
          <div id="footer-row1-4" class="span3 clearfix">  <?php print render($page['footer_col_1']); ?> </div>
	  <?php endif; ?>
	  <?php if ($page['footer_col_2']): ?>
          <div id="footer-row2-4" class="span3 clearfix"> <?php print render($page['footer_col_2']); ?> </div>
	  <?php endif; ?>
	  <?php if ($page['footer_col_3']): ?>
          <div id="footer-row3-4" class="span3 clearfix"> <?php print render($page['footer_col_3']); ?> </div>
	  <?php endif; ?>
	  <?php if ($page['footer_col_4']): ?>
          <div id="footer-row4-4" class="span3 clearfix"> <?php print render($page['footer_col_4']); ?> </div>
	  <?php endif; ?>
	</div>
  </div>
</div>
