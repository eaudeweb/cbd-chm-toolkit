...
function open_framework_preprocess_html(&$vars) {
  ...
  $vars['global_site_classes'] = theme_get_setting('global_site_classes');
...
function chm_dashboard_kit_preprocess_views_view(&$vars) {
  $view = &$vars['view'];
  // Make sure it's the correct view
  if ($view->name == 'cbd_parties') {
    // add needed javascript
    drupal_add_js('https://code.highcharts.com/maps/modules/exporting.js', array('type' => 'external', 'scope' => 'footer'));
    drupal_add_js('https://code.highcharts.com/mapdata/custom/world.js', array('type' => 'external', 'scope' => 'footer'));
    drupal_add_js('https://code.highcharts.com/maps/modules/data.js', array('type' => 'external', 'scope' => 'footer'));
    drupal_add_css('https://cloud.github.com/downloads/lafeber/world-flags-sprite/flags32.css', 'external');
    drupal_add_js('https://code.highcharts.com/maps/highmaps.js', array('type' => 'external', 'scope' => 'footer'));
